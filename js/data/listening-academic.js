...
EXAM.addQuestions([
  ...
  /* ═══════════════ SECTION 1 — DEFINE ═══════════════ */
  {
    ...
    spine: ['One discipline / narrow subject range', 'Specific language features', 'Favoured "where possible"', 'Because language varies by discipline'],
    core: [
  ...
  },
  {
    ...
    spine: ['Broad range of subjects', 'General language features', 'Default for mixed-discipline groups', 'IEP / pre-sessional / foundation'],
    core: [
  ...
  },
  {
    ...
    spine: ['Lecture = initiation into a community', 'Genres + behaviour of the discipline', 'Comprehension needs genre familiarity', 'Teacher bridges learner ↔ practice'],
    core: [
  ...
  /* ═══════════════ SECTION 2 — SHORT NOTE ═══════════════ */
  {
    ...
    spine: ['1 Psychometric — tests measure input effects', '2 Discourse analysis — features of the spoken text', '3 Strategy research — what strategies learners use', '4 Ethnographic — behaviour + beliefs of learner groups'],
    core: [
  ...
  },
  {
    ...
    spine: ['Narrow = one discipline, specific language', 'Wide = broad subjects, general language', 'Favour narrow: language varies by discipline', 'But mixed cohorts force wide'],
    core: [
      { type: 'distinction',
  ...
  },
  {
    ...
    spine: ['Critical = evaluate, not just process', 'Evidence · contradictions · bias · implications', 'Academic study = evaluating knowledge', 'Traditional materials stop at comprehension'],
    core: [
  ...
  },
  {
    ...
    spine: ['Intertextual = new text relates to known text', 'Recurring disciplinary patterns', 'Contextual = listening + reading/slides/notes', 'Scaffold: link to prior + wrap in support'],
    core: [
  ...
  /* ═══════════════ SECTION 3 — APPLICATION ═══════════════ */
  {
    ...
    spine: ['Problem: monologue speed + subtechnical lexis', 'Individualized: self-paced replay', 'Strategic: keyword/structure/purpose/notes', 'Self-access bank → strategy toolkit → targeted self-direction'],
    core: [
  ...
  },
  {
    ...
    spine: ['Problem: scripted materials = gap-fill, inauthentic', 'Critical: evaluate evidence/bias/contradiction', 'Intertextual: discipline series, recurring patterns', 'Authentic lectures → critical tasks → sequenced series'],
    core: [
