...
EXAM.addQuestions([
  ...
  /* ═══════════════ SECTION 3 — APPLICATION ═══════════════ */
  {
    ...
    section: 'application',
    operator: 'design',
    prompt: 'Contextual Application: K-12 Literacy in Saudi Public Schools. Many Saudi K-12 students struggle with "reading to learn" in late elementary and middle school because their English instruction has focused almost exclusively on "beginning-level decoding." Design a "scaffolded" lesson for a 7th-grade science-themed English text that moves them toward the "developing" stage of literacy.',
